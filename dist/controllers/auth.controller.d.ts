...
export declare function userRegisterController(req: Request, res: Response): Promise<void>;
export declare function userLoginController(req: Request, res: Response): Promise<void>;
export declare function getMeController(req: Request, res: Response): Promise<void>;
